...
!!! note "Check all four at every scheduled post-release review."
...
!!! important "The agent that has no defined retirement criteria is an agent nobody authorized to run indefinitely."
